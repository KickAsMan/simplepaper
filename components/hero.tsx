...
export const Hero = () => {
    return (
        <div className="max-w-[1110px] m-auto">
            <div className="w-full flex justify-center max-[950px]:flex-col max-[950px]:mx-10 md:mx-30 mt-15">
                <div>
                ...
                <div className="w-full max-[950px]:mt-5">
                    <picture>
                        <source srcSet="./cuttubus.png" media="(min-width: 950px)" />
